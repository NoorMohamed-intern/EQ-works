          ...
          <>
            <div className="dropdown-container">
              <Dropdown className="dropdown-basic">
                <Dropdown.Toggle variant="success">Line 1 Data</Dropdown.Toggle>
                <Dropdown.Menu>
                  <Dropdown.Item href="" onClick={() => setKey1("impressions")}>
                    Impressions
                  </Dropdown.Item>
                  <Dropdown.Item href="" onClick={() => setKey1("clicks")}>
                    Clicks
                  </Dropdown.Item>
                  <Dropdown.Item href="" onClick={() => setKey1("revenue")}>
                    Revenue
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
              <Dropdown className="dropdown-basic">
                <Dropdown.Toggle variant="success">Line 2 Data</Dropdown.Toggle>
                <Dropdown.Menu>
                  <Dropdown.Item href="" onClick={() => setKey2("impressions")}>
                    Impressions
                  </Dropdown.Item>
                  <Dropdown.Item href="" onClick={() => setKey2("clicks")}>
                    Clicks
                  </Dropdown.Item>
                  <Dropdown.Item href="" onClick={() => setKey2("revenue")}>
                    Revenue
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
              ...
              <tbody>
                {poi.map((p) => {
                  return (
                    <tr
                      className={
                        p.name.toLowerCase().includes(nameKey.toLowerCase()) &&
                        nameKey.length > 1
                          ? "highlighted"
                          : ""
                      }
